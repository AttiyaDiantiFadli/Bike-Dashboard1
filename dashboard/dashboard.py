...
try:
    ...
    st.error("File tidak ditemukan. Pastikan file berada di lokasi yang benar.")
    st.stop()
...
with st.sidebar:
    ...
    # Filter Rentang Tanggal (Pastikan Dikonversi ke Timestamp)
    ...
    # Konversi start_date & end_date ke pandas.Timestamp agar cocok dengan dteday
